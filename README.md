...
| Apache Airflow | <img src="images/airflow.png" width="100"> | Plataforma de código abierto para la gestión de flujos de trabajo de datos y automatización de procesos ETL. |
| Docker | <img src="https://www.docker.com/wp-content/uploads/2022/03/Moby-logo.png" width="100"> | Plataforma de contenedores que permite crear, desplegar y gestionar aplicaciones en entornos aislados y portables. | 
| Google Composer | <img src="images/composer.png" width="100"> | Servicio de Google Cloud que gestiona Apache Airflow, facilitando la creación y ejecución de flujos de trabajo en la nube. | 
| Amazon Redshift | <img src="images/images.png" width="100"> | Data warehouse escalable basado en la nube, optimizado para el análisis de grandes volúmenes de datos. | 
| PostgreSQL | <img src="https://upload.wikimedia.org/wikipedia/commons/2/29/Postgresql_elephant.svg" width="100"> | Sistema de gestión de bases de datos relacional y de código abierto que permite almacenar y gestionar datos de manera eficiente. | 
